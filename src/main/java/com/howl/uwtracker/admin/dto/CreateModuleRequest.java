 ...
 * null/blank, {@code uiVisible} to true when null. {@code manifestObject} and {@code patchNotesObject}
 * are both optional (an artifact need not have a manifest sidecar or patch notes).
 */
