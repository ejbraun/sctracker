...
Carries a one-line pointer to the **Plugins** and **Launcher** pages, which now hold every download
(`specs/frontend/09-downloads.md`). The Account page itself has no download panels.
