...
/** specs/frontend/02-account.md — profile + machine keys. Downloads live on /plugins and /launcher. */
    ...
    <div>
      ...
      <Panel className={styles.section}>
        ...
        <p className={styles.aliasHint}>
          Downloads: see <Link to="/plugins">Plugins</Link> and <Link to="/launcher">Launcher</Link>.
        </p>
